...
module "server_template_vmw_merger" {                      # <<-- Change to duplicate
  source = "github.com/bywhite/cen-iac-imm-dev-pod1-mods/imm-pod-servers-vmw-merger-mod"
...
# -----------------------------------------------------------------------------
  ...
  server_policy_prefix = "ofl-dev-pod1-vmw-merger"         # <<-- Change to duplicate
  ...
  tags = [
    ...
    { "key" : "ServerGroup", "value" : "ofl-dev-pod1-vmw-merger-srvgroup" } # <-- Change
  ]
