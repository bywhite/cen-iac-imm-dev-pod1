...
module "intersight_policy_bundle_bml_1" {
  ...
  source = "github.com/bywhite/cen-iac-imm-dev-pod1-mods//imm-domain-fabric-6454-mod?ref=v1.2.1"
...
# -----------------------------------------------------------------------------
  ...
  # For no FC, set to 0 and comment out all FC variables or set them to empty sets
