...
module "imm_domain_3" {                                                        # <-- change when copying
...
# -----------------------------------------------------------------------------
  ...
  policy_prefix = "${local.pod_policy_prefix}-domain-3"                        # <-- change when copying
  ...
  tags = [
    ...
    { "key" : "domain", "value" : "${local.pod_policy_prefix}-domain-3" }      # <-- change when copying
  ]
