...
module "imm_domain_6" {                                                        # <-- change when copying
...
# -----------------------------------------------------------------------------
  ...
  policy_prefix = "${local.pod_policy_prefix}-domain-6"                        # <-- change when copying
  ...
  tags = [
    ...
    { "key" : "domain", "value" : "${local.pod_policy_prefix}-domain-6" }      # <-- change when copying
  ]
