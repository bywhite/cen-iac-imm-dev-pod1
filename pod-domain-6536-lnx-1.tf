...
module "intersight_policy_bundle_lnx_1" {             # <-- change when copying
  ...
  source = "github.com/bywhite/cen-iac-imm-dev-pod1-mods//imm-domain-fabric-6536?ref=v1.2.1a"
...
# -----------------------------------------------------------------------------
  ...
  eth_breakout_count = 2         # Must enumerate eth_aggr_server_ports when breakouts exist
